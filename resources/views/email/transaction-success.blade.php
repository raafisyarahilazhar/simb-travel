                            ...
                            <tr>
                              <td align="left" style="font-size: 0px; padding: 10px 25px; padding-right: 25px; padding-left: 25px; word-break: break-word">
                                <div style="font-family: Assistant, Helvetica, Arial, sans-serif; font-size: 18px; line-height: 20px; text-align: left; color: #071c4d">
                                  Hi, {{ $data->user->name }} <br /><br />
                                  Tiket digital kamu sudah berhasil dicetak. <br />
                                  Booking ID <strong>#{{ $data->user->id }}</strong>
                                </div>
                              </td>
                            </tr>
                            <tr>
                                    ...
                                    <td align="center" bgcolor="#FF9E53" role="presentation" style="border: none; border-radius: 10px; cursor: auto; mso-padding-alt: 10px 25px; background: #ff9e53" valign="middle">
                                      <a
                                        style="
                                          ...
                                          background: #ff9e53;
                                          color: #ffffff;
                                          font-family: Assistant, Helvetica, Arial, sanf-serif;
                                          font-size: 18px;
                                          font-weight: normal;
                                          line-height: 120%;
                                          margin: 0;
                      ...
                      <td align="left" style="font-size: 0px; padding: 10px 25px; word-break: break-word">
                        ...
                        >
                          <tr>
                            ...
                            <td style="font-size: 18px; padding-left: 10px; color: #071c4d; font-family: Assistant, Helvetica, Arial, sans-serif">
                              support@nomads.id <br />
                              021-2019-2022
                            </td>
                          </tr>
                        </table>
